...
const cases = [['file1.json', 'file2.json', 'resulttestjson.txt', 'stylish'], ['file1.yml', 'file2.yml', 'resulttestyml.txt', 'stylish'], ['file1.json', 'file2.json', 'resultplainjson.txt', 'plain'], ['file1.yml', 'file2.yml', 'resultplainyml.txt', 'plain']];
